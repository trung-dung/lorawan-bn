...
// Selection chip DIO object for SPI connect with external flash
Gpio_t flashCE;
...
void sFLASH_Init(void)
{
  ...
  /* Initializes the peripherals used by the SPI FLASH driver */
	HW_SPI1_Init();
	/*Init NSS for extern flash*/
	GpioInit( &flashCE, FLASH_CE, PIN_OUTPUT, PIN_PUSH_PULL, PIN_NO_PULL, 0 );
