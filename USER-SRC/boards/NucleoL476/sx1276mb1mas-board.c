...
void SX1276AntSwInit( void )
{
	...
	GpioInit( &RadioRxEn, RADIO_RXEN, PIN_OUTPUT, PIN_PUSH_PULL, PIN_NO_PULL, 0);	
	GpioInit( &RadioTxEn, RADIO_TXEN, PIN_OUTPUT, PIN_PUSH_PULL, PIN_NO_PULL, 0);
}
...
void SX1276SetAntSw( uint8_t opMode )
{
    ...
    case RFLR_OPMODE_TRANSMITTER:
		...
		GpioWrite( &RadioTxEn, 1 );
		GpioWrite( &RadioRxEn, 0 );		
        break;
    ...
    default:
		...
		GpioWrite( &RadioTxEn, 0 );
		GpioWrite( &RadioRxEn, 1 );	
        break;
    }
}
